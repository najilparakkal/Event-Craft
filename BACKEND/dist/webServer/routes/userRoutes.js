...
userRouter.post("/api/user/addBooking", Controller_1.default.addBooking);
userRouter.get("/api/user/bookings/:userId", Controller_1.default.getBooking);
userRouter.delete("/api/user/cancelBooking", Controller_1.default.cancelBooking);
