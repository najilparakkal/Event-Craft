...
import { fetchCouts } from '../../../API/services/user/Services';
...
const About: React.FC = () => {
    ...
    return (
        <div className="w-full min-h-screen  bg-black ">
            <Header />
            <section className="pt-7 h-full">
                <div className="container grid gap-8 items-center py-4 px-4 mx-auto lg:grid-cols-2 lg:py-8">
                    <div className="font-light text-gray-700 sm:text-lg mt-9 dark:text-gray-400">
                ...
                <div className="pt-8 mt-6 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
                    <a href="#" aria-label="Follow us on Facebook">
                        <svg width="20" height="20" fill="#FFFFFF" className="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" aria-label="Connect with us on LinkedIn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFFFFF" className="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-white" viewBox="0 0 1792 1792">
