  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="min-h-screen bg-black scrollNoDiv">
          <Header />
          <Notification />
          <main>
            <section className="relative">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end items-center text-white pb-8 sm:pb-12 px-4">
                ...
                <div className="flex ease-[cubic-bezier(0.95,0.05,0.795,0.035)] flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 mb-4 sm:mb-8 w-full max-w-xl">
                  <input
                    type="text"
