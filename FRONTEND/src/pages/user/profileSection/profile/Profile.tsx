...
const Profile: React.FC = () => {
    ...
    return (
        ...
        <main className="w-full min-h-screen py-1 md:w-2/3 lg:w-3/4 flex justify-end">
          <div className="p-2 md:p-4 w-full max-w-lg">
            <div className="px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
              ...
              <div className="flex flex-col items-center mt-8">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGZhY2h8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                  alt="Bordered avatar"
                />
              ...
              <div className="mt-8 sm:mt-14 text-[#202142] flex flex-col items-end">
                <div className="w-full">
                  <div className="flex flex-col mb-2 space-y-2 sm:flex-row sm:space-y-0 sm:space-x-4 sm:mb-6">
                    <div className="w-full">
